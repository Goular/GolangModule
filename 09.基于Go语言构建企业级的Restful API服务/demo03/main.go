...
import (
	...
	"net/http"
	"time"
	"ApiServer/demo03/router"
	"errors"
	"github.com/spf13/pflag"
	"ApiServer/demo03/config"
...
func main() {
	...
	//我修改配置文件之后提示这个：error: open E:\Go\GOPATH\src\gitee.wang\a\restfulapi\conf\config.yaml: The process cannot access the file because it is being used by another process.
